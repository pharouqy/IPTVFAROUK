    ...
    <div className={`w-full py-3 relative ${
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-center relative">
        ...
        <div className="flex flex-col items-center justify-center w-full">
          {/* Chargement */}
          {isLoading && (
            <div className={`flex items-center justify-center w-full max-w-3xl h-24 rounded-lg border-2 border-dashed shadow-sm ${
              theme === 'dark'
          ...
          {loadError && !isLoading && (
            <div className={`flex items-center justify-center w-full max-w-3xl h-24 rounded-lg border-2 ${
              theme === 'dark'
